...
define void @_Z3fooi(i32 %a) #0 !dbg !10 {
entry:
  ...
  store i32 %add, i32* %b, align 4, !dbg !18
  ret void, !dbg !21
}
...
entry:
  ...
  %pfunc = alloca void (i32)*, align 8
  store i32 0, i32* %retval, align 4
  call void @llvm.dbg.declare(metadata void (i32)** %pfunc, metadata !25, metadata !DIExpression()), !dbg !27
  store void (i32)* @_Z3fooi, void (i32)** %pfunc, align 8, !dbg !27
  %0 = load void (i32)*, void (i32)** %pfunc, align 8, !dbg !28
  call void %0(i32 2), !dbg !28
  ret i32 0, !dbg !29
}
...
!17 = !DILocalVariable(name: "b", scope: !10, file: !11, line: 3, type: !14)
...
!22 = distinct !DISubprogram(name: "main", scope: !11, file: !11, line: 6, type: !23, scopeLine: 7, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !0, retainedNodes: !2)
!23 = !DISubroutineType(types: !24)
!24 = !{!14}
!25 = !DILocalVariable(name: "pfunc", scope: !22, file: !11, line: 8, type: !26)
!26 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!27 = !DILocation(line: 8, column: 12, scope: !22)
!28 = !DILocation(line: 10, column: 5, scope: !22)
